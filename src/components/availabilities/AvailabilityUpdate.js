...
import {putAvailability, getAvailabilityById} from '../../services/availabilityService'
...
export const AvailabilityUpdate = () => {
    ...
    const getAvailability = async () => {
        try {
            ...
            Swal.showLoading();
            Swal.close();
            let { data } = await getAvailabilityById(availabilityId);
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await putAvailability(availabilityId, Model);
            console.log(data);
    ...
    return (
        ...
        onSubmit={(e) => { handleOnSubmit(e) }}>
            ...
            <div className='row'>
                ...
                <Link className='col-md-1' to={`/availability`}>
